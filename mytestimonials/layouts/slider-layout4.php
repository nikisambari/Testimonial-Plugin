...
<div class="slider-4-testimonial-page mySwiper">
    <div class="swiper-wrapper">
        ...
        $per_view_class = ($selected_perview === '1') ? 'per-view-1' : '';
        ...
        if (!empty($testimonials)) {
            foreach($testimonials as $testimonial) {
                ...
                <div class="testimonial-slider-4">
                        <div class="slider4-userdetails" style="background: <?php echo ($selected_bg === 'default') ? '#3498db' : $selected_bg; ?>">
                          <?php if($display_profile==='1'){ ?>
                                <div class="slider4-imgbox">
                                    <img src="<?php echo esc_url($testimonial->profile_photo);?>" alt="">
                                </div> 
                          <?php } ?>
                          <?php if ($display_username === '1') { ?> 
                                <div  class="slider4-detbox">
                           ...
                           if ($display_social_media === '1') {
                             ?>  
                           <div class="slider4-social-media-handles">
                             <?php 
                      ...
                      <?php } ?>
                        ...
                        <div class="silder4-quote"><h1 style="color: <?php echo ($selected_bg === 'default') ? '#3498db' : $selected_bg; ?>">“</h1></div>
